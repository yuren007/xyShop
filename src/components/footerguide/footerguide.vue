<template>
    <section id='foot_guide'>
        ...
        <section class="guide_item" @click="gotoAddress('/homepage')">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('homepage') !== -1? '#homepageActive' : '#homepage'"></use>
            </svg>
            <span>首页</span>
        </section>
        <section class="guide_item" @click="gotoAddress('/classification')">
            <svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('classification') !== -1? '#classificationActive' : '#classification'"></use>
            </svg>
            <span>分类</span>
        </section>
